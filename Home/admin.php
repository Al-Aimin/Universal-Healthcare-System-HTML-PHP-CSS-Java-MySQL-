...
<head>
  <meta charset="UTF-8">
  <title>UNIVERSAL HEALTHCARE Admin</title>
...
{
	$count=0;
	$res=mysqli_query($link,"select * from admin where usrname='$_POST[user]' && pass='$_POST[pass]'");
	...
	if($count==0)
	{
		...
		<div class="alert alert-danger col-lg-6 col-lg-push-3">
			<left><strong style="color:red">Invalid Username or Password</strong></left>
		</div>
	...
	else
	{
		...
		window.location="http://127.0.0.1/Project%20CSE-300/Home/records.php";
		</script>
		<?php
	}
}

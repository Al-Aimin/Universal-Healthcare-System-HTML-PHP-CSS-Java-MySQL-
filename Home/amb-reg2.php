...
<head>
    ...
    <title>AIR AMBULANCE RESERVATION</title>
	<!-- Bootstrap Styles-->
   ...
   <link href='http://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css' />
        ...
        <div id="page-wrapper" >
            ...
            <div class="col-md-12">
                        <h1 class="page-header">
                          AIR AMBULANCE RESERVATION <small></small>
                        </h1>
                 </div>
                </div> 
	...
	<?php
		if(isset($_POST["submit1"]))
		{
		  ...
		  mysqli_query($link,"insert into air values('','$_POST[name]','$_POST[address]','$_POST[phone]','220','not send','due')");
